...
// src/components/ExpensesPage/FilterSheet.jsx
import React from 'react';
import { Box } from '@mui/material';
import { FilterPanel } from './FilterPanel'; // Import the new component

export const FilterSheet = React.memo((props) => {
  // This is now a simple wrapper that provides a container for the panel on mobile
  return (
    <Box sx={{ p: 2 }}>
      <FilterPanel {...props} />
    </Box>
